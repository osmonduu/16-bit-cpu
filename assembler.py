...
# parse_four_bits takes a string representing a register or immediate for an R or I type instruction
# and return a string of 4-bits representing the register/immediate.
...
# return a string of 16-bits representing the instruction in binary.
def parse_assembly_instr(line: str) -> str :
  ...
  # J-type instruction
    ...
    addr = parts[1]
    # check if the value can be represented as a 12-bit signed number
    ...
    # do nothing; raise an erorr since the code should never get here
    raise ValueError("Idk how you got here. There shouldn't be another type.")


# parse_twelve_bits will take a string representing an immediate between -2048 and 2047 inclusive
# and return a string representing the immediate as a 12-bit sign-extended number.
...
# parse_file translates the assembly instructions in input_file to hexadecimal bytes
# and writes to output_file, padding to 64 bytes.
...
if __name__ == "__main__":
  ...
  print(f"Assembled. Written to {output_file}")